...
return ( <div className="min-h-screen bg-gray-50 text-slate-900">
...
```
  ...
  {/* BIENVENIDA */}
  <section id="inicio" className="border-b bg-white">
    <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 py-16 md:grid-cols-2 md:py-24">

      <div>
        <p className="mb-3 text-sm font-semibold tracking-widest text-emerald-600">
        ...
        <p className="mt-6 max-w-xl text-base leading-7 text-slate-500 md:text-lg">
          Encuentra viajes compartidos con otros estudiantes
          de manera sencilla, económica y segura.
        </p>

        <Button
          onClick={handleBuscar}
          className="mt-8 flex items-center gap-2 bg-emerald-600 text-white hover:bg-emerald-700"
        >
          <Search size={18} />
          Buscar un viaje
        </Button>
  ...
  {/* BUSCAR VIAJE */}
  <section id="buscar" className="px-6 py-20">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <Card className="transition-shadow hover:shadow-lg">
          <CardContent className="p-6">
            ...
            <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-lg bg-emerald-50 text-emerald-600">
              <Search size={23} />
            </div>
            ...
            <p className="mt-3 text-sm leading-6 text-slate-500">
              Encuentra viajes disponibles de acuerdo
              con tu origen y destino.
            </p>

            <Button
              variant="ghost"
              onClick={handleBuscar}
              className="mt-5 px-0 text-emerald-600 hover:bg-transparent hover:text-emerald-700"
            >
              Buscar viaje →
            </Button>
  ...
  {/* INFORMACIÓN DE UNIRIDE */}
  <section id="uniride" className="border-t px-6 py-20">
    <div className="mx-auto grid max-w-6xl gap-12 md:grid-cols-2 md:items-center">
      ...
      <div>
        ...
        <p className="mt-5 max-w-xl leading-7 text-slate-500">
          ...
          busca ofrecer una alternativa práctica, económica
          y colaborativa para la comunidad universitaria.
        </p>
      </div>
